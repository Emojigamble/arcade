                    ...
                    <StatusDisplay
                        message={
                            <div className="-mt-1 flex-row">
                                ...
                                >
                                    <p>
                                        <span className="flex -mb-2"><IoLogIn className="my-auto mr-2"/> Continue Anonymous</span>
                                        <span className="text-xs opacity-0 group-hover:opacity-50">Your progress won't be saved</span>
                                    </p>
                                </button>
                            </div>
                        }
