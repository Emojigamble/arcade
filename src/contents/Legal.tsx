...
export default function Legal({ sitenotice, privacypolicy }) {
  return (
    <div className="w-screen min-h-screen cursor-default">
      <Cursor />
      <Navbar />
          ...
          <>
            ...
            <p
              dangerouslySetInnerHTML={{
                __html: process.env.REACT_APP_RESPONSIBLE,
              }}
            ></p>
            <h2>Contact</h2>
            <p
              dangerouslySetInnerHTML={{
                __html: process.env.REACT_APP_CONTACT,
              }}
            ></p>
            ...
            <p>
              ...
              were not detected at the time of the linking. A permanent
              monitoring of the contents of linked websites cannot be imposed
              without reasonable indications that there has been a violation of
              law. Illegal links will be removed immediately at the time we get
              knowledge of them.
            </p>
            <h3>Copyright</h3>
            <p>
        ...
        {privacypolicy && (
          <>
            ...
            <p>
              ...
              Personal data collected on this website are stored on the servers
              of the host. These may include, but are not limited to, IP
              addresses, contact requests, metadata and communications, contract
              information, contact information, names, web page access, and
              other data generated through a web site.
            </p>
            <p>
              The host is used for the purpose of fulfilling the contract with
              our potential and existing customers (Art. 6(1)(b) GDPR) and in
              the interest of secure, fast, and efficient provision of our
              online services by a professional provider (Art. 6(1)(f) GDPR).
            </p>
            <p>
            ...
            <p
              dangerouslySetInnerHTML={{ __html: process.env.REACT_APP_HOSTER }}
            ></p>
            ...
            <p>
              Among other things, tools of companies domiciled in the United
              States or other from a data protection perspective non-secure
              non-EU countries, are integrated into our website. If these tools
              are active, your personal data may potentially be transferred to
              these non-EU countries and may be processed there. We must point
              out that in these countries, a data protection level that is
              comparable to that in the EU cannot be guaranteed. For instance,
              U.S. enterprises are under a mandate to release personal data to
              the security agencies and you as the data subject do not have any
            ...
            <p>
              ...
              of certain functions you want to use (functional cookies, e.g.,
              for the shopping cart function) or those that are necessary for
              the optimization of the website (e.g., cookies that provide
              measurable insights into the web audience), shall be stored on the
              basis of Art. 6(1)(f) GDPR, unless a different legal basis is
              ...
              obtained (Art. 6(1)(a) GDPR); this consent may be revoked at any
              time.
            </p>
            <p>
            ...
            <p>
              ...
              with Google. The provider of this service is Google Ireland
              Limited (“Google”), Gordon House, Barrow Street, Dublin 4,
              Ireland.
            </p>
            <p>
              To register with Google, you must only enter your Google name and
              password. Google will identify you and confirm your identity to
              our website.
            </p>
            <p>
              ...
              decide whether you want this information to be used and if so,
              which information it is, within the framework of your Google
            ...
            <p>
              The data processing associated with Google’s registration is based
              on our legitimate interest in making the registration process as
              simple as possible for our users (Art. 6(1)(f) GDPR). Since the
